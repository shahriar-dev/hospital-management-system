<?php
require "../../../Hospital-Management-System/Patient/model/dbPassword.php";
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    if (isset($_POST['submit'])) {
        ...
        if (!$emptyField) {
            $response = changePassword($Username, $Email, $Password);

            if ($response) {
                $Message = "Password Changed Successfully!";
                $color = 'green';
            } else {
                $Message = "Couldn't connect to database!Try again..";
                $color = 'red';
            }
